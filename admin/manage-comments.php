                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">QUẢN LÝ BÌNH LUẬN ĐÃ ĐƯỢC DUYỆT</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($st == 0) : ?>
                                                                    <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']); ?>" title="Disapprove this comment"><span>Ẩn</span></a>
                                                                <?php else : ?>
                                                                    <a href="manage-comments.php?appid=<?php echo htmlentities($row['id']); ?>" title="Approve this comment"><span>Duyệt</span></a>
                                                                <?php endif; ?>

                                                                &nbsp;<a href="manage-comments.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"><span>Xoá</span></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
