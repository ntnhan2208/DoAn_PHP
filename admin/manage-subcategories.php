...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'perdel' && $_GET['scid']) {
        ...
        $delmsg = "Danh mục con đã được xoá vĩnh viễn!";
    }
                        ...
                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-subcategory.php?scid=<?php echo htmlentities($row['subcatid']); ?>"><span>Sửa</span></a>
                                                                &nbsp;<a href="manage-subcategories.php?scid=<?php echo htmlentities($row['subcatid']); ?>&&action=del"> <span>Xoá</span></a> </td>
                                                        </tr>
                                                <?php
                                                                $cnt++;
                                                            }
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            <h4><i class="fa fa-trash-o"></i>Danh mục con đã bị xoá</h4>
                                        </div>
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row['subcatpostingdate']); ?></td>
                                                            <td><?php echo htmlentities($row['subcatupdationdate']); ?></td>
                                                            <td><a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']); ?>"><span>Phục hồi</span></a>
                                                                &nbsp;<a href="manage-subcategories.php?scid=<?php echo htmlentities($row['subcatid']); ?>&&action=perdel"><span>Xoá</span></a> </td>
                                                        </tr>
                                                <?php
                                                                $cnt++;
                                                            }
