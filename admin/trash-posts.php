                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">BÀI VIẾT ĐÃ XOÁ</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']); ?>&&action=restore" onclick="return confirm('Bạn muốn phục hồi bài viết?')"><span>Phục hồi</span></a>
                                                                &nbsp;
                                                                <a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']); ?>&&action=perdel" onclick="return confirm('Bạn muốn xoá vĩnh viễn bài viết?')"><span>Xoá</span></a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                        } ?>
