...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            echo "<script>alert('Sử dụng hình ảnh jpg / jpeg/ png /gif');</script>";
        } else {
                                ...
                                <div class="p-6">
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Tạo bài viết</button>
                                            <button type="button" class="btn btn-danger waves-effect waves-light">Huỷ bỏ</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
