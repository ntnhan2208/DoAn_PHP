...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'parmdel' && $_GET['rid']) {
        ...
        $delmsg = "Danh mục đã được xoá vĩnh viễn!";
    }
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">QUẢN LÝ DANH MỤC CHA</h4>
                        ...
                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-category.php?cid=<?php echo htmlentities($row['id']); ?>"><span>Sửa</span></a>
                                                                &nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"><span>Xoá</span></a> </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
                                                    } ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            <h4><i class="fa fa-trash-o"></i> Danh mục cha đã bị xoá</h4>
                                        </div>
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row['PostingDate']); ?></td>
                                                            <td><?php echo htmlentities($row['UpdationDate']); ?></td>
                                                            <td><a href="manage-categories.php?resid=<?php echo htmlentities($row['id']); ?>"><span>Phục hồi</span></a>
                                                                &nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']); ?>&&action=parmdel"><span>Xoá</span> </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
                                                    } ?>
