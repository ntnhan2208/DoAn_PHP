                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="edit-post.php?pid=<?php echo htmlentities($row['postid']); ?>"><span>Sửa</span></a>
                                                            &nbsp;<a href="manage-posts.php?pid=<?php echo htmlentities($row['postid']); ?>&&action=del" onclick="return confirm('Bạn muốn xoá bài viết?')"> <span>Xoá</span></a> </td>
                                                    </tr>
                                            <?php }
                                                    } ?>
